    ...
    <Card title="Transcoder (play MKV / HEVC in-browser)">
      <div style={{ padding: 20 }}>
        ...
        <p style={{ fontSize: 13, color: '#8a8a8a', margin: '0 0 14px', lineHeight: 1.5 }}>
          Browsers can't decode MKV/HEVC. Deploy the free transcoder (see <strong style={{ color: '#b3b3b3' }}>transcoder/README.md</strong> — one-click on{' '}
          <button onClick={() => window.open('https://railway.app', '_blank', 'noopener')} style={{ background: 'transparent', border: 0, color: 'var(--accent,#E50914)', cursor: 'pointer', fontFamily: 'inherit', fontSize: 13, padding: 0, textDecoration: 'underline' }}>Railway</button>),
