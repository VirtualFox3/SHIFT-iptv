    ...
    <div style={{
      ...
      <nav style={{ display: 'flex', gap: 20, fontSize: 14, flexShrink: 0 }}>
        ...
        {categories.length > 0 && (
          <div style={{ position: 'relative' }} onClick={(e) => e.stopPropagation()}>
            ...
            {catOpen && (
              <div className="nfx-scroll" style={{ position: 'absolute', top: 32, left: -16, background: 'rgba(15,15,15,0.97)', border: '1px solid var(--hair-2)', borderRadius: 4, padding: '10px 0', minWidth: 420, maxHeight: 380, overflowY: 'auto', boxShadow: '0 12px 30px rgba(0,0,0,0.7)', backdropFilter: 'blur(10px)', zIndex: 60 }}>
      ...
      <div style={{ marginLeft: 'auto', display: 'flex', gap: 18, alignItems: 'center', color: 'var(--ink-1)' }}>
        ...
        <div style={{ position: 'relative' }} onClick={(e) => e.stopPropagation()}>
          ...
          {menuOpen && (
            <div style={{ position: 'absolute', top: 42, right: 0, background: 'rgba(15,15,15,0.97)', border: '1px solid var(--hair-2)', borderRadius: 4, padding: '8px 0', minWidth: 220, boxShadow: '0 12px 30px rgba(0,0,0,0.7)', backdropFilter: 'blur(10px)', zIndex: 60 }}>
