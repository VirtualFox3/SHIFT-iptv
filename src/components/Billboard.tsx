  ...
  const Meta = (
    <>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12, flexWrap: 'wrap', justifyContent: centered ? 'center' : 'flex-start' }}>
        ...
        <span style={{ color: '#d2d2d2' }}>{title.genres.slice(0, 3).join(' · ')}</span>
      </div>
    ...
    <div style={{ position: 'relative', height: 680, marginBottom: -120, marginTop: -66, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', left: 48, bottom: 200, maxWidth: 580, color: '#fff' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 18 }}>
          ...
          <span style={{ fontSize: 14, fontWeight: 600, letterSpacing: '0.04em', color: '#e5e5e5' }}>{channel.name} · CH {channel.num}</span>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24, maxWidth: 400 }}>
          ...
          <span style={{ fontSize: 13, color: '#d2d2d2', whiteSpace: 'nowrap' }}>Up next · {channel.next}</span>
        </div>
      ...
      <div style={{ position: 'absolute', right: 48, bottom: 224, display: 'flex', alignItems: 'center', gap: 16 }}>
        <span style={{ fontSize: 13, color: '#e5e5e5', display: 'flex', alignItems: 'center', gap: 6 }}>
  ...
  return (
    <div style={{ position: 'relative', height: 600, marginTop: -66, marginBottom: 10, overflow: 'hidden', background: '#0c0c0c', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
      ...
      <div style={{ position: 'absolute', left: 0, right: 0, bottom: 22, display: 'flex', justifyContent: 'center', gap: 8, flexWrap: 'wrap', padding: '0 24px' }}>
        {chips.map((c, i) => (
          <button key={c} style={{ fontFamily: 'inherit', fontWeight: 600, fontSize: 13.5, padding: '8px 18px', borderRadius: 999, cursor: 'pointer', border: i === 0 ? '0' : '1px solid rgba(255,255,255,0.25)', background: i === 0 ? '#fff' : 'rgba(255,255,255,0.05)', color: i === 0 ? '#0a0a0a' : '#e5e5e5', transition: 'all 150ms' }}>{c}</button>
        ))}
      </div>
    </div>
  );
  ...
  return (
    <div style={{ position: 'relative', marginTop: -66, padding: '100px 48px 20px', background: '#0c0c0c' }}>
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 14, color: '#8a8a8a', fontWeight: 600, marginTop: 6 }}>
